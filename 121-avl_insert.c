...
/**
 * avl_insert_full - This inserts a value into an AVL tree
 *
...
/**
 * balance_checker - This rebalances an AVL tree if needed
 *
 ...
 * Return: void
 */
void balance_checker(avl_t **root, avl_t *tree, int value)
{
	int new_balance;
...
avl_t *avl_insert(avl_t **tree, int value)
{
	...
	{
		balance_checker(tree, predecessor, value);
